...
export default async function NewBatchPage() {
  ...
  const [suppliersResult, exchangeRateResult] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight">New Purchase Batch</h2>
          <p className="text-muted-foreground">
            Record a new hair purchase from a supplier
          </p>
        </div>
      </div>
